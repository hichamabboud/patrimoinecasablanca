  ...
  return (
    <div className="w-full flex flex-col min-h-[100vh]">
      <Head>
        ...
        <main className="relative z-10 overflow-hidden bg-white py-14 px-4 lg:py-[120px]">
            <div className="container mx-auto">
                ...
                <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                    ...
                    <div className="mb-8 flex w-full max-w-[370px]">
                        <div
                        className="bg-blue-600 text-blue-600 mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]"
                        >
                        <svg
                            width="24"
                            height="24"
                    ...
                    <div className="mb-8 flex w-full max-w-[370px]">
                        ...
                        <div className="w-full">
                        <h4 className="text-dark mb-1 text-xl font-bold">Téléphone</h4>
                        <a href="tel:+212660277332" className="text-body-color text-base">(+212) 6 60 27 73 32</a>
                        </div>
                    </div>
                    <div className="mb-8 flex w-full max-w-[370px]">
                        <div
                        ...
                        <a href="mailto:sarhane.taoufik@gmail.com" className="text-body-color text-base">sarhane.taoufik@gmail.com</a>
                        </div>
                    </div>
                    </div>
                </div>
                <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
                    ...
                    <form>
                        ...
                        <input
                            ...
                            className="text-body-color border-[f0f0f0] focus:border-blue-600 w-full rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
                        />
                        </div>
                        <div className="mb-6">
                        <input
                        ...
                        <textarea
                            ...
                            className="text-body-color border-[f0f0f0] focus:border-blue-600 w-full resize-none rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
                        ></textarea>
                        </div>
                        <div>
                        <button
                            type="submit"
                            className=" bg-blue-600 border-blue-600 w-full rounded border p-3 text-white transition hover:bg-opacity-90"
                        >
                            Envoyer
                        </button>
                        </div>
