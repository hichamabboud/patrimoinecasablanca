...
const contact = () => {
  return (
    <div>
        ...
        <section className="bg-white py-20 lg:py-[120px] overflow-hidden relative p-10">
                ...
                <div className="w-full lg:w-1/2 xl:w-6/12 px-4">
                    <div className="max-w-[570px] mb-12 lg:mb-0">
                      ...
                      <div className="flex mb-8 max-w-[370px] w-full">
                          ...
                          <Link href={"https://goo.gl/maps/X6VJxZioTmZPsrXd7"}>
                            <a className="text-base text-body-color">
                              <span className=" font-bold text-gray-500 block " > 
                              Centre de la jeunesse Moulay Rachid</span>
                              Boulevard BOUKAMAA ABOU SAID CASABLANCA MAROC
                            </a>
                          </Link>
                          </div>
                      </div>
                      <div className="flex mb-8 max-w-[370px] w-full">
                          ...
                          <div className="w-full">
                            <h4 className="font-bold text-dark text-xl mb-1">Tel:</h4>
                            <a href="tel:212660277332" className="text-base text-body-color" >+212 6 60 27 73 32</a>
                          </div>
                      </div>
                      <div className="flex mb-8 max-w-[370px] w-full">
                          <div
                          ...
                          <div className="w-full">
                            ...
                            <a href="mailto:sarhane.taoufik@gmail.com" className="text-base text-body-color">sarhane.taoufik@gmail.com</a>
                          </div>
                      </div>
                    </div>
                </div>
